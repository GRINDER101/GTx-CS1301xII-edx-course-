...
def check_blood_pressure(systolic, diastolic):
    if ((systolic >= 140 and systolic <= 190) and (diastolic >= 40 and diastolic <= 100)) or ((systolic >= 70 and systolic <= 190) and (diastolic >= 90 and diastolic <= 100)):
        return "High"
    elif ((systolic >= 120 and systolic < 140) and (diastolic >= 40 and diastolic <= 100)) or ((systolic >= 70 and systolic <= 190) and (diastolic >= 80 and diastolic < 90)):
        return "Pre-high"
    elif ((systolic >= 90 and systolic < 120) and (diastolic >= 40 and diastolic <= 100)) or ((systolic >= 70 and systolic <= 190) and (diastolic >= 60 and diastolic < 80)):
        return "Ideal"
    else:
        return "Low"
