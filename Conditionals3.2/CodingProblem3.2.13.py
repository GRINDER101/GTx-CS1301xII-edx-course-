...
renewal_cost = round(20 + ((1/100) * car_value))


if emissions_passed or electric or (driver_age >= 65 and car_age > 10):
    if purchase_year < 2013 and electric:
        renewal_cost = round(200 + (20 + ((1/100) * car_value)))
        print("Your renewal fee is $" + str(renewal_cost) + ".")
    if purchase_year < 2013 and electric == False:
        renewal_cost = round(20 + ((1/100) * car_value))
        print("Your renewal fee is $" + str(renewal_cost) + ".")
    if purchase_year >= 2013 and electric:
        renewal_cost = round(200 + 20)
        print("Your renewal fee is $" + str(renewal_cost) + ".")
    if (purchase_year >= 2013 and electric == False):
        renewal_cost = round(20)
        print("Your renewal fee is $" + str(renewal_cost) + ".")
else:
