...
rounded_extra_money = round(extra_money, 2)
rounded_needed_money = round(needed_money, 2)

if amount > goal:
    print("You'll exceed your goal by " + str(rounded_extra_money))
else:
    print("You'll fall short of your goal by " + str(rounded_needed_money))
