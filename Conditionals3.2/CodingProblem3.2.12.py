...
if phase == "Full" and distance < 230000 and (date == 29 or date == 30 or date == 31) and eclipse:
    print("Super Blue Blood Moon")
elif phase == "Full" and distance < 230000 and eclipse:
    print("Super Blood Moon")
elif phase == "Full" and (date == 29 or date == 30 or date == 31) and eclipse:
